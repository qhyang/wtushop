		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<div style="color:#FF0000"><s:actionerror /></div><!-- 回显错误信息 -->
...
<div class="container footer">
	<div class="span24">
	  <div class="footerAd"><img src="${pageContext.request.contextPath}/images/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势" /></div>	
	</div>
	<div class="span24">
		<ul class="bottomNav">
					<li>
