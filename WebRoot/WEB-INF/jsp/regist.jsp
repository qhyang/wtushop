...
<script>
	    function checkUsername(){//ajax异步校验
		// 获得文件框值:
		...
		xhr.onreadystatechange = function(){
			if(xhr.readyState == 4){//后台处理完成 ，完成交互，接手响应 
				if(xhr.status == 200){//，服务器不但收到，而且正确处理后给你回发了
					document.getElementById("span1").innerHTML = xhr.responseText;//写到span1
				}
			}
		}
		// 3.打开连接
	...
	function change(){
		...
		img1.src="${pageContext.request.contextPath}/checkImg.action?time="+new Date().getTime();//解决缓存问题
	}
</script>
</head>
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<div>
						<s:actionerror /> <!--接收错误信息（验证码）-->             <!-- 当前的数据用post方法传递 在服务器端可用response.post("表单域名")来获得数据-->
					</div>
						...
						<table>
							<tbody><tr>
								...
								<td>
									...
									<span id="span1"></span>
									<div style="color:#FF0000"> <span><s:fielderror fieldName="username"/>
									</span></div>
							...
							<tr>
								...
								<td>
									...
									<div style="color:#FF0000"> <span><s:fielderror fieldName="password" /></span></div>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									...
									<div style="color:#FF0000"><span><s:fielderror fieldName="repassword"/></span></div>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									...
									<div style="color:#FF0000"><span><s:fielderror fieldName="email"/></span></div>
								</td>
							</tr>
									<tr>
										<th>
										...
										<td>
												...
												<div style="color:#FF0000"><span><s:fielderror fieldName="name"/></span></div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>    
												<input size="10" type="text" name="phone" class="text" />
												<div style="color:#FF0000"> <span><s:fielderror fieldName="phone" /></span></div>
									...
									<tr>
										...
										<td>
												...
												<div style="color:#FF0000"> <span><s:fielderror fieldName="addr"/></span>
										</td>
									</tr>
								<tr>
									<th>
