...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">//使用AJAX异步获取当前这个订单的订单项
			function showDetail(oid){
				var but = document.getElementById("but"+oid);//获得按钮
				var div1 = document.getElementById("div"+oid);//获得div对象
				if(but.value == "订单详情"){
					// 1.创建异步对象
									...
									<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<div id="div<s:property value="#o.oid"/>"><!-- 加载订单项 -->
												</div>
											</td>
